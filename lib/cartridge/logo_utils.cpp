...
std::vector<std::vector<int>> decode_nintendo_logo(std::vector<std::string> nintendo_logo) {
...
void decode_and_print_logo(BYTE logo[0x30]){
  ...
  std::vector<std::vector<int>> logo_decoded = decode_nintendo_logo(logo_encoded);
